...
func init() {
	...
	accountDescSource := accountFields[12].Descriptor()
	...
	// account.SourceValidator is a validator for the "source" field. It is called by the builders before save.
	account.SourceValidator = accountDescSource.Validators[0].(func(string) error)

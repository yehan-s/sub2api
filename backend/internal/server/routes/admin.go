...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/sync/prod/status", h.Admin.Account.SyncProdStatus)
		accounts.POST("/sync/prod/preview", h.Admin.Account.PreviewFromProd)
		accounts.POST("/sync/prod", h.Admin.Account.SyncFromProd)
